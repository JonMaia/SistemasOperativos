...
class Memory():
    ...
    def __init__(self, size):
        self._cells = [''] * size # Crea un array de memoria con el tamaño pasado como parámetro
...
HARDWARE = Hardware()
# La variable establecida fuera de cualquier script es global, no sería una buena práctica